 ...
 */
public class SourceSendingTask extends SourceTask {
    ...
    public List<SourceRecord> poll() throws InterruptedException {
        ...
        for (int i = 0; i < NUMBER_OF_EVENTS_TO_GENERATE; i++) {
            ...
            SourceRecord srcRecord = new SourceRecord(partition, ccOffset, topic,
                    Schema.INT32_SCHEMA, id, Schema.STRING_SCHEMA,
                    "American whole magazine truth stop whose. On traditional measure example sense peace. 489-24115-7 R59-DLN Christine Tran 80160 Clayton Isle Apt. 513\nEast Linda, FL 71671 Ball floor meet usually. Feeling fact by four. " + seqno);

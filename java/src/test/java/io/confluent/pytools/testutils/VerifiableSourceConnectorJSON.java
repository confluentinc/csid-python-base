 ...
 */
public class VerifiableSourceConnectorJSON extends SourceConnector {
    ...
    public Class<? extends Task> taskClass() {
        return VerifiableSourcePairSendingTaskJSON.class;
    }
    ...
    public List<Map<String, String>> taskConfigs(int maxTasks) {
        ...
        for (int i = 0; i < maxTasks; i++) {
            ...
            props.put(VerifiableSourcePairSendingTaskJSON.ID_CONFIG, String.valueOf(i));
            configs.add(props);
        }
        return configs;
    }

...
class SpacyModel:
    ...
    def load(self):
        ...
        print(f"(down)loading spacy model: {self.model_name} (sys.executable={sys.executable})")

        spacy.cli.download(self.model_name)

#        commands = [sys.executable, "-m", "spacy", "download", self.model_name]
...
def init_models(models):
    ...
    models_to_load = list_or_string_to_list(models) if models else ['en_core_web_sm']
